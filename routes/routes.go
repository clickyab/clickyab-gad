...
func (tc *selectController) Routes(e *echo.Echo, _ string) {
	...
	e.GET("/allads", tc.allAdsTemp, middlewares.RequestCollectorGenerator(webCopCreateor), middlewares.Header)
...
func (selectController) assetRoute(asset string) echo.HandlerFunc {
	return func(c echo.Context) error {
		return c.HTML(200, string(staticbins.MustAsset(asset)))
	}
}
