...
var vastConfig = map[string]map[string][]string{
	...
	"default": {
		"start":    {"linear", "11", "00:00:10", "00:00:03"},
		"00:00:10": {"non-linear", "22", "00:00:12"},
		"end":      {"linear", "13", "00:00:10", "00:00:03"},
	},
	"long": {
		"start":    {"linear", "11", "00:00:10", "00:00:03"},
		"00:00:20": {"non-linear", "22", "00:00:12"},
		"00:01:20": {"non-linear", "23", "00:00:12"},
		"00:03:20": {"non-linear", "24", "00:00:12"},
		"00:05:20": {"non-linear", "25", "00:00:12"},
	},
}
