        ...
        <div class="cyb-title cyb-custom-title">{{.Title}}</div>
         <div class="cyb-title-after cyb-custom-title-after"></div>
            ...
            <div class="cyb-logo">
                ...
                <a href="https://www.clickyab.com/?ref=icon" class="cyb-logo-container">
