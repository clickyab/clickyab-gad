...
.cyb-holder .cyb-title-holder .cyb-logo .cyb-logo-container img.cyb-logo-color {
  opacity: 0;
}
.cyb-holder .cyb-title-holder .cyb-logo .cyb-logo-container img.cyb-logo-gray {
  opacity: 1;
}
.cyb-holder .cyb-title-holder .cyb-logo:hover .cyb-logo-container {
  left: 0;
}
.cyb-holder .cyb-title-holder .cyb-logo:hover .cyb-logo-container .cyb-logo-color {
  opacity: 1;
}
.cyb-holder .cyb-title-holder .cyb-logo:hover .cyb-logo-container .cyb-logo-gray {
  opacity: 0;
}
